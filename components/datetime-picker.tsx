    ...
    <div className={cn("space-y-2", className)}>
      <div className="relative" ref={popoverRef}>
        <Button
          ...
          className={cn(
            "w-full justify-start text-left font-normal bg-white/5 border-white/20 text-white hover:bg-white/10 h-10 sm:h-11 touch-manipulation",
                ...
                selectedDay !== null && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        <Label className="text-white/70 text-xs sm:text-sm mb-2 block">
                        ...
                        <Input
                          ...
                          className="bg-white/5 border-white/20 text-white focus:border-white/40 h-12 sm:h-11 text-base sm:text-sm"
                          step="60"
                        />
                    ...
                    <div className="flex gap-2 pt-4 border-t border-white/10">
                      ...
                      <Button
                        ...
                        className="flex-1 bg-white text-black hover:bg-white/90 disabled:opacity-50 h-12 sm:h-10 touch-manipulation"
                      >
                        Apply
                      </Button>
                    </div>
